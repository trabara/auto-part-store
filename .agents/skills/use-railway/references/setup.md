...
|---|---|
| `docker.io/railway/postgres*` or `postgres:*` | Postgres |
| `docker.io/railway/redis*` or `redis:*` | Redis |
| `docker.io/railway/mysql*` or `mysql:*` | MySQL |
| `docker.io/railway/mongo*` or `mongo:*` | MongoDB |
