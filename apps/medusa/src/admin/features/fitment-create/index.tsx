import { Button, FocusModal, ProgressTabs, toast, usePrompt } from "@medusajs/ui"
...
const CreateFitmentModal = ({ productId }: { productId?: string }) => {
    ...
    const mutation = useMutation({
        mutationFn: async (data: CreateFitmentInput) => sdk.client.fetch('/admin/fitments', {
            method: "POST",
    ...
    const TabContent = useMemo(() => {
        ...
        return () => <ProgressTabs.Content value={active}><step.Component /></ProgressTabs.Content>
    }, [active])
            ...
            <FocusModal open onOpenChange={handleCancel}>
                <FocusModal.Content asChild>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)}>
                        <ProgressTabs value={active} onValueChange={handleTabsChange} className="flex h-full flex-col overflow-hidden">
                            <FocusModal.Header>
