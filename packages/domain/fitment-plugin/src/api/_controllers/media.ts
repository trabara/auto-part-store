...
import {
  CreateEntityImagesInput,
  UpdateEntityImagesInput,
} from "@trabara/core/dtos";
import {
  createEntityImagesWorkflow,
  deleteEntityImagesWorkflow,
  updateEntityImagesWorkflow,
} from "../../workflows/entity-media";
