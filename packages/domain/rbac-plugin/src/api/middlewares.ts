...
export const adminRolesMiddlewares: MiddlewareRoute[] = [
  ...
  },
  {
    ...
    method: "POST",
    middlewares: [validateAndTransformBody(AssignUsersSchema)],
  },
];
...
export const adminPermissionsMiddlewares: MiddlewareRoute[] = [
  ...
  },
  {
    matcher: "/admin/rbac/v2/permissions",
    method: "POST",
    middlewares: [validateAndTransformBody(CreatePermissionSchema)],
  },
  {
    matcher: "/admin/rbac/v2/permissions/:id",
    method: "PATCH",
    middlewares: [validateAndTransformBody(UpdatePermissionSchema)],
  },
  {
    matcher: "/admin/rbac/v2/permissions/:id",
    method: "DELETE",
...
export const adminCategoriesMiddlewares: MiddlewareRoute[] = [
  ...
  },
  {
    matcher: "/admin/rbac/v2/categories",
    method: "POST",
    middlewares: [validateAndTransformBody(CreateCategorySchema)],
  },
  {
    matcher: "/admin/rbac/v2/categories/:id",
    method: "PATCH",
    middlewares: [validateAndTransformBody(UpdateCategorySchema)],
  },
  {
    matcher: "/admin/rbac/v2/categories/:id",
    method: "DELETE",
