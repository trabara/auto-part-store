...
const medusaAppDir = process.argv[3]
  ...
  : path.resolve(pluginDir, "../../apps/backend");

// Sentinel file inside apps/backend/src — touching it triggers Medusa's
 ...
 * Touches apps/backend/src/plugin-reload.ts to trigger Medusa's watcher.
 */
