...
import { useEntityImageMutations } from "../hooks/use-entity-image"
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (hasNewImages) {
                ...
                operations.push(createImagesMutation.mutateAsync(imagesToCreate as Omit<EntityImage, "id">[]))
            }
            ...
            <FocusModal.Content>
                ...
                <FocusModal.Body className="flex h-full overflow-hidden">
                    ...
                    <CommandBar open={selectedImageIds.size > 0}>
                        <CommandBar.Bar>
                            <CommandBar.Value>
                                {selectedImageIds.size} {t('media.command.selected', { count: selectedImageIds.size })}
                            </CommandBar.Value>
